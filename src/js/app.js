...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name ? variables.name : "Juanito"} ${
    variables.lastName ? variables.lastName : "Alcachofa"
  }</h1>
          <h2>${variables.role ? variables.role : "Amante de los gatos"}</h2>
          <h3>${variables.city ? variables.city : "A Coruña"}, ${
